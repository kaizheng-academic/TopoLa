...
import Louvain_TopoLa 

def save_data(adata, label_key, resolution_key, filename='saved_data.pkl'):
    with open(filename, 'wb') as f:
        pickle.dump((adata, label_key, resolution_key), f)
...
def cluster_optimal_resolution(
    ...
    **kwargs,
    ...
    if cluster_function is None:
        cluster_function = Louvain_TopoLa.louvain
    ...
    for res in resolutions:
        ...
        if score_max < score:
            ...
            adata_max = adata
            label_key_max = label_key
            cluster_key_max = resolution_key

    #save_data(adata_max, label_key_max, cluster_key_max)
...
def opt_louvain(
    ...
    **kwargs,
    ...
    for res in [0.1]:
        Louvain_TopoLa.louvain(adata, resolution=None, key_added=cluster_key,TopoLa_bool=TopoLa_bool,TopoLa_alpha=TopoLa_alpha)
